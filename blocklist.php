				  ...
				  <form method='post' action=''>
                        <td>
				 		...
				 		<td>
							...
							<button class="btn btn-success" name=" 'block'<?php echo$y;?>" type="submit" value="submit">UNBLOCK</button>
...
?>
	...
	<tr valign="top" >
		...
		<?php } //}?>
			...
			{
			$delete1="delete from block where mediaid='$mediaid[$z]' and username='$uname'";
